#!/bin/sh
env="MPE"
scenario="simple_coverage_cnn_sparse_localj_attention_noise"
num_landmarks=0
num_agents=10
nb_additional_data=2
algo="rmappo"
exp="local_coverage_attention_noise"
seed_max=1
...
do
    ...
    --model_dir "/home/thales/jszpirer/sugar/mappo/onpolicy/scripts/results/coverage10agentsattentionnoise3steps_seed1/files" \
    ...
    --wheel_noise 0.21 --loss_probability 0.85 --use_directions
done
