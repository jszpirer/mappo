...
do
    ...
    --model_dir "/home/thales/jszpirer/sugar/mappo/onpolicy/scripts/results/MPE/simple_coverage_cnn_sparse/mappo/simple_coverage_cnn_sparse77/wandb/run-20250515_154120-l2xowd7r/files" \
