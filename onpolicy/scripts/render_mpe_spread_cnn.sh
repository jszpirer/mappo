...
num_agents=3
algo="mappo"
exp="simple_spread_cnn_initpoos"
seed_max=1
...
do
    ...
    --model_dir "/home/thales/jszpirer/sugar/mappo/onpolicy/scripts/results/MPE/simple_spread_cnn_initpos/mappo/simple_spread_cnn_initpos/wandb/latest-run/files" \
    --use_wandb False
done
