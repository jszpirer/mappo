#!/bin/sh
env="MPE"
scenario="simple_coverage_cnn_sparse_localj_omni" 
num_landmarks=0
num_agents=5
grid_resolution=77
grid_resolution_critic=39
nb_additional_data=2
noise=0
stride=2
kernel=7
algo="rmappo" #"mappo" "ippo"
exp="simple_coverage_cnn_sparse77_local_omni_direct_continuous_withoutnoise"
seed_max=10
...
do
    ...
    --stride ${stride} --kernel ${kernel} --save_interval 1000000 --omniscient_critic --grid_resolution_critic ${grid_resolution_critic} --use_directions --discrete_action
done
