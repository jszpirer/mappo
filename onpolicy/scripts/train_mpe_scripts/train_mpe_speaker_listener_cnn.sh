...
exp="simple_speaker_listener_cnn_77_nobias_sparse_epoch10"
seed_max=1
project="simple_speaker_listener_normal_time_test"
...
do
    ...
    --ppo_epoch 10 --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --user_name "jeanne-szpirer-universit-libre-de-bruxelles" --project_name ${project} \
