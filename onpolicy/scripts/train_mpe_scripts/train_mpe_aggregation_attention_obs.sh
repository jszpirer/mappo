...
exp="local_coverage_aggregation_attention_actor_critic"
seed_max=5
project="epuck_aggregation_obs_5agents"
...
do
    ...
    --save_interval 1000000 --omniscient_critic --use_directions --attention_critic --num_obstacles ${num_obstacles}
done
