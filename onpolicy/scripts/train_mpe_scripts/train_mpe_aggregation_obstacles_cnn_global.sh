#!/bin/sh
env="MPE"
scenario="simple_aggregation_obs_cnn_global" 
num_landmarks=0
num_agents=5
...
exp="coverage_aggregation_obs_cnn_global"
seed_max=5
...
do
    ...
    --save_interval 1000000 --omniscient_critic --velocities_critic --kernel 7 --stride 2
done
