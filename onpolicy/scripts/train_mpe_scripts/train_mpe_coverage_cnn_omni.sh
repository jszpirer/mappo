...
exp="simple_coverage_cnn_sparse77_local_omni_withoutnoise"
seed_max=10
...
do
    ...
    --stride ${stride} --kernel ${kernel} --save_interval 1000000 --omniscient_critic --grid_resolution_critic ${grid_resolution_critic}
done
