#!/bin/sh
env="MPE"
scenario="simple_coverage_cnn_sparse_localj_attention_global_render"
num_landmarks=0
num_agents=10
nb_additional_data=2
algo="rmappo"
exp="local_coverage_attention_newglobal_velocities_render"
seed_max=1
...
do
    ...
    --use_wandb False --nb_additional_data ${nb_additional_data} --attention_actor --heatmap \
    --omniscient_critic --velocities_critic --attention_critic --d_model 32 --grid_resolution 77
done
