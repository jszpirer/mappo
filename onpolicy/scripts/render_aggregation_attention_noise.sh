#!/bin/sh
env="MPE"
scenario="simple_coverage_aggregation_cnn_sparse_localj_attention_local_noise"
num_landmarks=0
num_agents=10
grid_resolution=77
stride=2
...
do
    ...
    --model_dir "/home/thales/jszpirer/sugar/mappo/onpolicy/scripts/results/aggregation10agentsattentionnoise_seed1/files" \
