...
do
    ...
    --model_dir "/home/thales/jszpirer/sugar/mappo/onpolicy/scripts/results/MPE/simple_speaker_listener_cnn_local/mappo/simple_speaker_listener_cnn_local/wandb/run-20250322_162652-1pt9oglh/files" \
