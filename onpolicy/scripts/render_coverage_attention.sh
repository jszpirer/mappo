#!/bin/sh
env="MPE"
scenario="simple_coverage_cnn_sparse_localj_noise_critic_action"
num_landmarks=0
num_agents=10
grid_resolution=77
stride=2
...
do
    ...
    --model_dir "/home/thales/jszpirer/sugar/mappo/onpolicy/scripts/results/dispersion10agentslocalnoisecurriculum_seed7/files" \
