...
class Scenario(BaseScenario):
    def make_world(self, args):
        ...
        world.occupancy_grid = np.zeros((args.grid_resolution, args.grid_resolution), dtype=np.int32)
        # add agents
    ...
    def reset_world(self, world):
        ...
        world.occupancy_grid = np.zeros((world.grid_resolution, world.grid_resolution), dtype=np.int32)
